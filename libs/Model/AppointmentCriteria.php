...
require_once("DAO/AppointmentCriteriaDAO.php");

/**
 * The AppointmentCriteria class extends AppointmentDAOCriteria and is used
 ...
 * @version 1.0
 */
class AppointmentCriteria extends AppointmentCriteriaDAO
{
