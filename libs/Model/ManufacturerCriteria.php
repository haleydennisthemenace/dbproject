...
require_once("DAO/ManufacturerCriteriaDAO.php");

/**
 * The ManufacturerCriteria class extends ManufacturerDAOCriteria and is used
 ...
 * @version 1.0
 */
class ManufacturerCriteria extends ManufacturerCriteriaDAO
{
