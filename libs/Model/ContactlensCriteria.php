...
require_once("DAO/ContactlensCriteriaDAO.php");

/**
 * The ContactlensCriteria class extends ContactlensDAOCriteria and is used
 ...
 * @version 1.0
 */
class ContactlensCriteria extends ContactlensCriteriaDAO
{
