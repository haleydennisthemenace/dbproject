...
require_once("DAO/GlasseslensCriteriaDAO.php");

/**
 * The GlasseslensCriteria class extends GlasseslensDAOCriteria and is used
 ...
 * @version 1.0
 */
class GlasseslensCriteria extends GlasseslensCriteriaDAO
{
