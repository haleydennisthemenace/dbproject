...
require_once("DAO/OptometristCriteriaDAO.php");

/**
 * The OptometristCriteria class extends OptometristDAOCriteria and is used
 ...
 * @version 1.0
 */
class OptometristCriteria extends OptometristCriteriaDAO
{
