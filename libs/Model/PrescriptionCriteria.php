...
require_once("DAO/PrescriptionCriteriaDAO.php");

/**
 * The PrescriptionCriteria class extends PrescriptionDAOCriteria and is used
 ...
 * @version 1.0
 */
class PrescriptionCriteria extends PrescriptionCriteriaDAO
{
